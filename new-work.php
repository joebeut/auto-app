    ...
    <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11">
      ...
      <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
        <table class="table sans">
          <thead>
            <tr>
              <th class="col-lg-8 col-md-8 col-sm-8 col-xs-8"><h5 class="caps section-header light-grey">Work Items</h5></th>
        ...
        <table class="table sans">
          <thead>
            <tr>
              <th class="col-lg-8 col-md-8 col-sm-8 col-xs-8"><h5 class="caps section-header light-grey">Labor Cost</h5></th>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <h5 class="sans caps section-header light-grey">Comments</h5>
        </div>
